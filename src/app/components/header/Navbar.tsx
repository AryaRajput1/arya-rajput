...
const Navbar = () => {
    ...
    return (
        <nav className="max-w-6xl flex justify-between items-center m-auto">
            ...
            <ul className='h-full flex text-white gap-6'>
                {
                    NAV_ITEMS.map((navItem) => {
                        return <li key={navItem.name} >
                            <Link href={navItem.href} className='flex justify-between items-center p-4 hover:bg-black gap-2'>
